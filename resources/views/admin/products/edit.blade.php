                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $product->name) }}" class="mt-1 block w-full p-2 border rounded-md @error('name') border-red-500 @enderror" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="4" class="mt-1 block w-full p-2 border rounded-md @error('description') border-red-500 @enderror">{{ old('description', $product->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="price" id="price" value="{{ old('price', $product->price) }}" step="0.01" class="mt-1 block w-full p-2 border rounded-md @error('price') border-red-500 @enderror" required>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center space-x-6">
                                ...
                                <div class="flex items-center">
                                    <input type="radio" id="discount_type_bs" name="discount_type" value="bs" class="form-radio text-blue-500" @checked(old('discount_type') == 'bs' || !$product->discount_type) />
                                    <label for="discount_type_bs" class="ml-2 text-sm text-gray-700">Descuento en Bs</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" id="discount_type_percentage" name="discount_type" value="percentage" class="form-radio text-green-500" @checked(old('discount_type') == 'percentage' || $product->discount_type == 'percentage') />
                            ...
                            <div class="mt-4">
                                <input type="number" id="discount" name="discount" value="{{ old('discount', $product->discount ?? '') }}" step="0.01" class="form-input w-full @error('discount') border-red-500 @enderror" placeholder="Introduce descuento" required>
                            ...
                            <div id="discount_slider" class="mt-6 hidden">
                                ...
                                <div class="relative">
                                    <input type="range" id="percentage_slider" name="percentage_slider" min="1" max="50" step="1" value="{{ old('discount', $product->discount ?? 1) }}" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="stock" id="stock" value="{{ old('stock', $product->stock) }}" class="mt-1 block w-full p-2 border rounded-md @error('stock') border-red-500 @enderror" required>
                        ...
                        <div class="mb-4">
                            ...
                            @if ($product->image)
                                <div class="mt-2">
                                    <img src="{{ $product->image }}" alt="Imagen actual" class="w-32 h-32 object-cover">
                                </div>
                            @endif
                        </div>

                        <div class="flex justify-end">
                            <button type="submit" class="bg-primary text-white px-6 py-2 rounded-lg">{{ __('Actualizar Producto') }}</button>
                        </div>
                    </form>
                </div>
            </div>
