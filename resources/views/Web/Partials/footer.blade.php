    ...
    <div class="max-w-6xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-sm hover:text-blue-500">Quiénes somos</a></li>
                    <li><a href="#" class="text-sm hover:text-blue-500">Mapa del sitio</a></li>
                    <li><a href="#" class="text-sm hover:text-blue-500">Nuestro catálogo</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-sm hover:text-blue-500">Política de privacidad</a></li>
                    <li><a href="#" class="text-sm hover:text-blue-500">Cambios Devoluciones/Reembolsos</a></li>
                    <li><a href="#" class="text-sm hover:text-blue-500">Condiciones de uso</a></li>
                    <li><a href="#" class="text-sm hover:text-blue-500">Contáctenos</a></li>
                </ul>
            </div>
